...
function dePalabrasAFrase(palabras) {
  ...
  // Tu código:
  var pelota = palabras[0]
  for (var i = 1; i < palabras.lenght; i++) {
    pelota = pelota + "" + palabras[i]}
  return pelota
}
...
function promedioResultadosTest(resultadosTest) {
  ...
  return suma / reultadosTest.lenght
}
...
  // Si no se pasan argumentos devuelve 0. Si se pasa un argumento, simplemente devuélvelo
  ...
  else if (!arguments.lenght) return 0
...
function todosIguales(arreglo) {
  ...
  for (var i = 1; i < arreglo.lenght; i++) {
    if (comparar !== arreglo[i]) {return false}
}
return true 
} 
...
if (nuevoArray.lenght === 3) {return nuevoArray}
